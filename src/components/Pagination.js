...
class Pagination extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <nav className="nav-pagination" aria-label="Countries Pagination">
          <ul className="pagination-list">
            {
              pages.map( (page, index) => {
                if (page === LEFT_PAGE) return (
                  <li key={index} className="page-item">
                    <Link to='#' className='page-link' aria-label='Previous' onClick={this.handleMoveLeft}>
                ...
                return (
                  <li key={index} className={`page-item${ currentPage === page ? ' active' : ''}`}>
                    <Link className="page-link" to="#" onClick={ this.handleClick(page) }>{ page }</Link>
                  </li>
                );
